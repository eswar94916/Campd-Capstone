                    ...
                    <Form>
                        ...
                        <div className="card mb-3">
                            <div className="card-header d-flex justify-content-between align-items-center">
                                <p className="mb-0">Status Filters</p>
                                <a role="button" className="text-color-primary" onClick={this.handleStatusReset}>
                                    Reset
                                </a>
                            </div>

                            <p className="small text-muted mb-0 mt-0 p-1 pl-2">Project Development Status</p>
                            <div className="list-group list-group-flush">
                                <li className="list-group-item list-group-item-action d-flex  align-items-stretch">
                                    Proposals
                                    {this.hoverTip(
                                ...
                                <p className="small text-muted mb-0 mt-0 p-1 pl-2">Administrator Approval Status</p>
                                <li className="space-top list-group-item list-group-item-action d-flex align-items-stretch">
                                    Approved
                                ...
                                <p className="small text-muted mb-0 mt-0 p-1 pl-2">Project Recruiting Status</p>
                                <li className="space-top list-group-item list-group-item-action d-flex align-items-stretch">
                                    Recruiting
                                    {this.hoverTip(
                        ...
                        <div className="card mb-3">
                            <div className="card-header d-flex justify-content-between align-items-center">
                                <p className="mb-0">Tag Filters</p>
                                <a role="button" className="text-color-primary" onClick={this.handleTagReset}>
                                    Reset
                                </a>
                            </div>
                        ...
                        <div className="card mb-5">
                            <div className="card-header">Share This Filtered List</div>
                            <div className="card-body">
                                <p className="small mb-0">{this.generateQueryLink()}</p>
                            </div>
                        </div>
                    </Form>
                </div>
